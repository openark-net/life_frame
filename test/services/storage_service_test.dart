  ...
  group('StorageService', () {
    ...
    group('daily entry management', () {
      ...
      test('should get all entries and sort by timestamp', () async {
        ...
        final entries = decodedData.values
            ...
            .toList();
        entries.sort((DailyEntry a, DailyEntry b) => b.timestamp.compareTo(a.timestamp));
    ...
    group('DailyEntry model', () {
      ...
      test('should serialize and deserialize correctly', () {
        ...
        expect(deserializedEntry.stitchedPhotoPath, equals(entry.stitchedPhotoPath));
      });
      ...
      test('should create copy with modifications', () {
        ...
        expect(modifiedEntry.stitchedPhotoPath, equals('/test/stitched.jpg')); // Modified
      });
    });
  });
}